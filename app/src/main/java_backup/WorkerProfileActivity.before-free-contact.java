    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contact.setOnClickListener(v -> {
            ...
            new android.app.AlertDialog.Builder(this)
                    .setTitle("Unlock Contact")
                    .setMessage(
                            "Get this worker's phone number and contact them directly.\\n\\n" +
                            "Amount: ₹10"
                    )
                    .setPositiveButton("Unlock for ₹10", (dialog, which) -> {

                        new android.app.AlertDialog.Builder(this)
                                .setTitle("Contact Unlocked")
                                .setMessage(
                                        workerPhone.isEmpty()
                                                ? "Phone number is not available."
                                                : "Phone: " + workerPhone
                                )
                                .setPositiveButton("Call Worker", (d, w) -> {
